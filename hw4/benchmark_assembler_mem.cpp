...
int main() {
  ...
  benchmark("read_memory_every 2", read_memory_every2, p, n);
  benchmark("read_memory_everyk 4", read_memory_everyk, p, n, 4);
  benchmark("read_memory_everyk 8", read_memory_everyk, p, n, 8);
